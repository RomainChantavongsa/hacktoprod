/**
 * Middleware de validation pour les transporteurs
 */

/**
 * Valide les données de création d'un transporteur
 */
const validateCreateTransporteur = (req, res, next) => {
...
/**
 * Valide les données de mise à jour d'un transporteur
 */
const validateUpdateTransporteur = (req, res, next) => {
...
module.exports = {
  validateCreateTransporteur,
  validateUpdateTransporteur
};
