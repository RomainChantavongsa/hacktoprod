...
export const useRemorques = () => {
  ...
  const resetForm = () => setForm({ type_remorque: '', plaque_immatriculation: '', capacite_tonnes: '' })

  return { remorques, loading, error, form, handleChange, create, remove, reload: load, submitting, resetForm }
}
